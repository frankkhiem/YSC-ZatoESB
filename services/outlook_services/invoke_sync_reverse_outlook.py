...
class InvokeSyncReverseOutlook(Service):
  """ Nhận request gồm accessToken lấy user tương ứng, 
      gọi sync_reverse_outlook service đồng bộ ngược danh bạ sang Outlook
  """
  ...
  def handle(self):
    ...
    res_sync = self.invoke('sync-reverse-outlook.sync-reverse-outlook', {
      'userId': userId
    })
